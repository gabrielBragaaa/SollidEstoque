...
//        btnExcluirProduto.setOnAction(event -> removerProdutoSelecionado())
    ...
    public void finalizarSaida() {
        ...
        try {
            ...
            String nomeUsuario = usuarioLogado != null ? usuarioLogado.getUsername() : "Desconhecido";
            Paragraph usuarioVenda = new Paragraph("Técnico Responsável: " + nomeUsuario, regularFont);
            usuarioVenda.setSpacingBefore(10f);
            document.add(usuarioVenda);
